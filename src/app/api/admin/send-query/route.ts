    ...
    try {
        ...
        try {
            await transporter.sendMail({
                from: process.env.SMTP_FROM_EMAIL || process.env.SMTP_USER || 'admin@resqnet.com',
                to: agencyEmail,
                subject: `Query from Admin regarding ${agencyName || 'Agency Registration'}`,
                html: `
                    <div style="font-family: Arial, sans-serif; color: #333;">
                        <h2 style="color: #2563eb;">ResQNet Admin Query</h2>
                        <p>Dear ${agencyName || 'Agency Representative'},</p>
                        <p>You have received a query regarding your registration with ResQNet.</p>
